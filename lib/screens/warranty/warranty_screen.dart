...
class _WarrantyScreenState extends State<WarrantyScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _newClaim() async {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(children: [
                            ...
                            Expanded(child: ElevatedButton(onPressed: submit, child: const Text('Submit'))),
                          ]),
                        ],
                      ),
                    ),
    ...
    if (ok != true) return;
    final productName = selectedProduct?.name ?? productSearch.text.trim();
                                          ...
                                          itemBuilder: (_, i) {
                                            ...
                                            return ListTile(
                                              ...
                                              leading: CircleAvatar(
                                                ...
                                                child: Icon(Icons.verified_outlined, color: AppColors.indigo, size: 20),
                                              ),
                                              title: Text(w['product_name'] ?? '', style: const TextStyle(fontWeight: FontWeight.w600)),
                                              subtitle: Text('${w['customer_name'] ?? ''} • ${w['warranty_no']}',
